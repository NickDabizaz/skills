...
| Documents in the repo | `CONTEXT.md`, `DESIGN.md`, `CLAUDE.md` / `AGENTS.md`, `.issues/`; all gitignored | None. Only `.issues/` when the user chose `brainstorm`, `discuss-with-docs`, `prototype`, or `audit`; kept out of the remote via `.git/info/exclude` |
