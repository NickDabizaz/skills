...
- **Visual reference**: a ticket carrying one is built to match it exactly — structure, layout, copy, component hierarchy. A technical constraint that forces a departure is a deviation: put it to the user as one question with options and a recommendation, discuss-style, before building around it.
